...
class Entity
{
    ...
    public const DEVICEPARTNUMBERTYPE = 'devicepartnumbertype';
    ...
    public const CONSUMABLEMANUFACTORY = 'consumablemanufactory';
    public const CONSUMABLETYPE = 'consumabletype';
    public const CONSUMABLEOWNER = 'consumableowner';
    public const DEVICEMODELOWNER = 'devicemodelowner';
    ...
    public static function getEntities(): array
    {
        return [
            ...
            self::REQUESTSSTATS,
            self::REPAIRACTS,
            self::DEVICEPARTNUMBERTYPE, 
            self::CONSUMABLE,
            self::CONSUMABLEMANUFACTORY,
            self::CONSUMABLETYPE,
            self::CONSUMABLEOWNER,
